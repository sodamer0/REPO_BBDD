...
CREATE TABLE Cuidador(
  ...
  OtrosDatosCuidador VARCHAR(200)
);
...
CREATE TABLE Itinerario (
  idItinerario INT(3) PRIMARY KEY,
  NombreItinerario VARCHAR(50) NOT NULL,
  Guia INT(3) NOT NULL,
  HoraInicio TIMESTAMP NOT NULL,
  Duracion INT(3) NOT NULL,
  Longitud INT(3) NOT NULL,
  MaxVisitantes INT(2) NOT NULL,
  OtrosDatosItinerario VARCHAR(200),
  CONSTRAINT fk_Guia
    FOREIGN KEY (Guia) REFERENCES Guia(idGuia)
);
ALTER TABLE Itinerario MODIFY COLUMN HoraInicio TIME NOT NULL;
...
--------------------------------------------------------------------------------------------
CREATE TABLE Vive (
  idVive INT(4) PRIMARY KEY,
  idEspecie INT(4),
  idHabitat INT(5),
  Peligrosidad INT(2) NOT NULL,
  OtrosDatosVive VARCHAR(200),
  CONSTRAINT fk_Vive_Especie
    FOREIGN KEY (idEspecie) REFERENCES Especie(idEspecie),
  CONSTRAINT fk_Vive_Habitat
...
CREATE TABLE RECORRE (
  idRecorre INT(3) PRIMARY KEY,
  Itinerario INT(3),
  Habitat INT(5),
  Fecha DATE NOT NULL,
  Incidencias VARCHAR(200),
  OtrosDatosRecorre VARCHAR(200),

  CONSTRAINT fk_Itinerario
    FOREIGN KEY (Itinerario) REFERENCES Itinerario(idItinerario),
  CONSTRAINT fk_Habitat
    FOREIGN KEY (Habitat) REFERENCES Habitat(idHabitat)
);
